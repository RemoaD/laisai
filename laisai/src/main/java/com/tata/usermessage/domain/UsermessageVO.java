package com.tata.usermessage.domain;

import java.io.Serializable;
import java.util.Date;

public class UsermessageVO implements Serializable {
	private int sendapplicationid;
	private int besendapplicationid;
	...
	public int getBesendapplicationid() {
		return besendapplicationid;
	}

	public void setBesendapplicationid(int besendapplicationid) {
		this.besendapplicationid = besendapplicationid;
	}

	public int getSendapplicationid() {
		return sendapplicationid;
	}

	public void setSendapplicationid(int sendapplicationid) {
    ...
    public boolean equals(Object that) {
        ...
        UsermessageVO other = (UsermessageVO) that;
